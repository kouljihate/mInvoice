import flet as ft
from app.fe.mobile.widgets.theme import PRIMARY, SECONDARY, CARD_BG, BACKGROUND, BORDER_COLOR, TEXT_SECONDARY, SUCCESS, ERROR, WARNING, border_all
from app.fe.mobile.widgets.theme import LANG_EN, LANG_AR, LANG_FR, LANG_NAMES, LANG_FONTS, FONT_COMFORTAA, FONT_REEM
